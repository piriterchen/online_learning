...
function expand_all(&$expanded) {
  ...
  $conn = db_connect();
  $query = "select postid from t_chforum_header where children = 1";
...
function get_post($postid) {
  ...
  $query = "select * from t_chforum_header where postid = '".$postid."'";
  $result = $conn->query($query);
  ...
  $query = "select * from t_chforum_body where postid = '".$postid."'";
...
function get_post_title($postid) {
  ...
  //get all header information from 'header'
  $query = "select title from t_chforum_header where postid = '".$postid."'";
  $result = $conn->query($query);
  if($result->num_rows!=1) {
    return '';
  }
...
function get_post_message($postid) {
  ...
  $query = "select message from t_chforum_body where postid = '".$postid."'";
  $result = $conn->query($query);
