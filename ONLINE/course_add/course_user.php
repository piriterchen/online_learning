...
<?php
    ...
    <td width="75%" height="150" bgcolor="#F9F9F9" id="page"
						style="cursor:pointer" onclick="window.parent.location.href='<?php echo "../course.php?courseid=$course_id";?>';" onmouseover="this.style.backgroundColor='#B0E0E6'" onmouseout="this.style.backgroundColor=''">
...
?>
  <tr width="90%" id="image1">
   <td>
   <img src="../image/guanzhu.jpg"/>
   </td>
  </tr>
  <tr width="90%" id="image1">
    <td>
   <img src="../image/unguanzhu.jpg"/>
   </td>
  </tr>
 </table>
<?php
