...
<!-- ********************************************************工程技术**************************************************-->
	<div class="main_bg_first row">
		<div class="col-sm-4 course_label col-md-2 col-lg-2 text-center" style="background-color: #BA55D3;box-shadow: 
  ...
  if(count($courseid) <= 4){
	  for($count=0; $count < count($courseid); $count++){	
	  	$id2=$courseid[$count];
	  ?>  
	    <div class="col-sm-4 col-md-2 course_type col-lg-2 text-center">
  ...
  <?php
	...
	<div class="col-sm-4 col-md-2 course_type col-lg-2 text-center">
		...
		<h4><a href="<?php $id_temp=$courseid[$number]; echo "./course.php?courseid=$id_temp";?>"><?php echo $coursename[$number];?></a></h4>
	</div>
	<?php
			}
		}
...
<!-- ********************************************************农林医药**************************************************-->
	<div class="main_bg row">
		<div class="col-xs-6 col-sm-4 col-md-2 course_label col-lg-2 text-center" style="background-color: #BA55D3;box-shadow: 
         inset 1px -1px 1px #444, inset -1px 1px 1px #444;" >
    <h2>农林医药</h2>
    </div>
  <?php
  ...
  if(count($courseid) <= 4){
	  for($count=0; $count < count($courseid); $count++){	
	  	$id3=$courseid[$count];
	  ?>  
	    <div class="col-xs-6 col-sm-4 col-md-2 course_type col-lg-2 text-center">
	    	<img src="<?php echo $courseimage[$count];?>" />
  ...
  <?php
	...
	<div class="col-xs-6 col-sm-4 col-md-2 course_type col-lg-2 text-center">
		<img src="<?php $number=$count+5+$count_row*6;echo $courseimage[$number];?>" />
			<h4><a href="<?php $id_temp=$courseid[$number];echo "./course.php?courseid=$id_temp";?>"><?php echo $coursename[$count];?></a></h4>
	</div>
	<?php
			}
		}
